...
app.whenReady().then(()=>{
    ...
    ipcMain.handle("createCapture",(_event,camera,width,height,framerate,preset="ultrafast")=>{pyInterface.invokeRequest("createCapture",[camera,width,height,framerate,preset="ultrafast"])})
    ...
    ipcMain.handle("getCapDetails",(id)=>{return pyInterface.invokeRequest("getCapDetails",id)})
